...
<head>
  ...
  <title>
  National Election - Political Parties
  </title>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-info" href="parties.php">
        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <h4 class="text-white text-uppercase font-weight-bolder text-center mt-2 mb-0">ACTIVE POLITICAL PARTIES</h4><br />
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-secondary font-weight-bolder">Party Id</th>
                      <th class="text-secondary font-weight-bolder ps-1">Party Name</th>
                      <th class="text-secondary font-weight-bolder ps-2">Party Identification Color</th>
                      <th class="text-secondary font-weight-bolder ps-2">Party Office Location</th>
                  ...
                  <?php
                  $query = mysqli_query($con, "SELECT * FROM parties,locations WHERE parties.office_location=locations.location_id");
                  ...
                  if ($rowcount == 0) {
                      ...
                      <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <p class="text-sm mb-0"><?php echo htmlentities($row['party_id']); ?></p>
                          </div>
                      </div>
                      </td>
                      <!-- Name -->
                      ...
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['party_color']); ?></p>
                      </td>
                      <td>
