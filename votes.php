...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-info" href="votes.php">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h4 class="text-white text-uppercase font-weight-bolder text-center mt-2 mb-0">ALL CURRENT VOTES MADE</h4><br />
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-secondary font-weight-bolder">Vote Number</th>
                      <th class="text-secondary font-weight-bolder ps-1">Voted Position</th>
                      <th class="text-secondary font-weight-bolder ps-2">Voted Party</th>
                      <th class="text-secondary font-weight-bolder ps-2">Voter's Category</th>
                      <th class="text-secondary font-weight-bolder ps-2">Voter's Validation Number</th>
                      <th class="text-secondary font-weight-bolder ps-2">When Voted</th>
                  ...
                  <?php
                  $query = mysqli_query($con, "SELECT * FROM votes,positions,parties,categories,registrations 
                  WHERE votes.position_id=positions.position_id 
                  AND votes.party_id=parties.party_id 
                  AND votes.voter_category=categories.category_name 
                  AND votes.vote_validation_id=registrations.registration_id ORDER BY votes.vote_id");
                  ...
                  if ($rowcount == 0) {
                      ...
                      <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <p class="text-sm mb-0"><?php echo htmlentities($row['vote_id']); ?></p>
                          </div>
                      </div>
                      </td>
                      <!-- Name -->
                      ...
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['party_name']); ?></p>
                      </td>
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['category_name']); ?></p>
                      </td>
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['registration_id']); ?></p>
                      </td>
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['voting_date']); ?></p>
                      </td>
