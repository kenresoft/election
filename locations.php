...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-info" href="locations.php">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h4 class="text-white text-uppercase font-weight-bolder text-center mt-2 mb-0">ALL LOCATIONS FOR ELECTORAL PROCESS</h4><br />
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-secondary font-weight-bolder">Location Id</th>
                      <th class="text-secondary font-weight-bolder ps-1">Location Name</th>
                  ...
                  if ($rowcount == 0) {
                      ...
                      <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <p class="text-sm mb-0"><?php echo htmlentities($row['location_id']); ?></p>
                          </div>
                      </div>
                      </td>
                      <!-- Name -->
