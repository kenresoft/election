...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
      <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-info" href="registrations.php">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h4 class="text-white text-uppercase font-weight-bolder text-center mt-2 mb-0">ALL REGISTERED VOTER FOR THE ELECTION</h5><br />
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-secondary font-weight-bolder">Registration Id</th>
                      <th class="text-secondary font-weight-bolder ps-1">Voter Category</th>
                      <th class="text-secondary font-weight-bolder ps-2">Voter Id</th>
                      <th class="text-secondary font-weight-bolder ps-2">Voter Name</th>
                      <th class="text-secondary font-weight-bolder ps-2">Voter Age</th>
                      <th class="text-secondary font-weight-bolder ps-2">Voter Gender</th>
                      <th class="text-secondary font-weight-bolder ps-2">Registration Date</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
                  ...
                  <?php
                  $query = mysqli_query($con, "SELECT registration_id,
                  ...
                  if ($rowcount == 0) {
                      ...
                      <!-- Name -->
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['voter_category']); ?></p>
                      </td>
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['voter_id']); ?></p>
                      </td>
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['voter_name']); ?></p>
                      </td>
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['voter_age']); ?></p>
                      </td>
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['voter_gender']); ?></p>
                      </td>
                      <td>
                        <p class="text-sm mb-0"><?php echo htmlentities($row['registration_date']); ?></p>
                      </td>
